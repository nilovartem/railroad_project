...
EXECUTE STATION_UPDATE(P_ID  => 22 /*IN NUMBER(38)*/, P_NAME  => 'Сандарово' /*IN VARCHAR2*/, P_ZONE_ID  => 44 /*IN NUMBER(38)*/)
EXECUTE STATION_UPDATE(P_ID  => 21 /*IN NUMBER(38)*/, P_NAME  => '283 км' /*IN VARCHAR2*/, P_ZONE_ID  => 44 /*IN NUMBER(38)*/)
